    ...
    <div className="px-5 bg_line py-20">
      <div className="container 2xl:max-w-[1320px] mx-auto py-5">
        ...
        <div className="flex flex-wrap xl:gap-10 sm:gap-7 gap-3 my-10 pb-10 justify-center max-w-[900px] mx-auto">
          {tokenData.map((obj, i) => (
            <div className="w-[200px] sm:h-[200px] border-[1.5px] border-[#FFDD00] rounded-[16px] flex flex-col justify-between items-center sm:px-4 px-3 am:py-8 py-5 cursor-pointer hover:translate-y-[-5px] transition-all duration-300 ease-in-out">
              <span>{obj.icon}</span>
